...
router.get("/paper/open", controller.openPaper);
router.get("/paper/stats", controller.paperStats);
router.post("/paper/activate", controller.activatePaper);
router.post("/paper/:symbol/activate", controller.activatePaper);
router.post("/paper/update", controller.updatePaper);
