...
const create = async (req, res) => { try { const result = await journal.createJournalEntry(req.body || {}); res.status(201).json({ success: true, created: true, entry: result.entry }); } catch (error) { sendError(res, error); } };
